...
3x24 jam`},{id:2,case:`Tidak bisa aktivasi Error Lain`,Bracket:e=>`#Pelangganbyu
[byU ${e}]
Nomor by.U : xxxxxx
Email by.U : --
...
DISCLAIMER
Oke Kak, Aku konfirmasi kembali pada tanggal ${Ya()} kakak mau proses UNREGISTRASI nomor by.U yang bukan milik Kakak tetapi terdaftar dengan NIK Kakak dengan data berikut
...
4. CP dan Email yang bisa dihubungi :`,Mandatory:(e,t)=>`#Pelangganbyu
[byU ${e}] 
Pelanggan by.U
${t} 
...
3x24 jam`},{id:67,case:`CCA UE_Handset_Problem_4G`,Bracket:e=>`#Pelangganbyu
[byU ${e}]
Nomor by.U : xxxxxx
Email akun by.U : --
Detail case : sinyal/internet
...
3x24 jam`},{id:68,case:`CCA Radio_lambat`,Bracket:e=>`#Pelangganbyu
[byU ${e}]
Nomor by.U : xxxxxx
Email akun by.U : --
Detail case : sinyal/internet
...
`),l=c[c.length-1].match(/^(\d+)\.\s*/);if(!l)return;e.preventDefault();let u=Number(l[1])+1,d=o+`\n${u}. `+s;t.current=o.length+`\n${u}. `.length,i(a(d))},className:`border w-full h-screen p-2`,placeholder:`Isi note kamu.....`})}var xo=()=>((0,l.useEffect)(()=>{let e=e=>{let t={F1:0,F2:2,F3:4,F4:1,F6:3,F7:5};if(e.ctrlKey&&e.key===`F1`){e.preventDefault();let t=localStorage.getItem(`my-templates`);if(!t)return;let n=JSON.parse(t);n[0]=`Hai Kak aku Odi temennya Nindy.`,n[2]=`Aku cek dulu interaksinya ya nanti aku balik lagi :)`,n[4]=`Makasih datanya. Aku cek dulu ya. Ditunggu :)`,n[1]=`Kak maaf, aku cek dulu ya. Ditunggu :)`,n[3]=`Makasih juga udah interaksi ya Kak :) Ohiya, aku akhiri obrolan kita ya, Kaka jangan dulu tutup chatnya ya karena setelah ini juga ada pop-up survey yang lain. Dibantu isi ya Kak kalau Kaka merasa puas boleh banget isi dengan angka (10) dan seterusnya ya. Makasih banget udah selalu setia sama by.U Kak :) selamat menunaikan ibadah puasa ya. Semoga dilancarkan puasanya dan sehat selalu🌙`,n[5]=`Makasih udah nunggu ya Kak aku ajuin pelaporan dulu dengan ID xxxxx ya. Nanti hasilnya bakal dikabarin sama tim kami lewat SMS/email ya :) Ditunggu maksimal 1x24 jam ya :) Ohiya, aku akhiri obrolan kita ya, Kaka jangan dulu tutup chatnya ya karena setelah ini juga ada pop-up survey yang lain. Dibantu isi ya Kak kalau Kaka merasa puas boleh banget isi dengan angka (10) dan seterusnya ya. Jangan sungkan buat chat aku lagi meskipun bulan puasa gini Nindy tetep standby buat kamu di waktu siang, berbuka dan waktu sahur juga pastinya. Have a nice day, semangat war Takjil ya Kak. Hihi🤗💙💛💚`,localStorage.setItem(`my-templates`,JSON.stringify(n)),window.dispatchEvent(new Event(`templates-updated`));return}if(e.key in t){e.preventDefault();let n=localStorage.getItem(`my-templates`);if(!n)return;try{let r=JSON.parse(n)[t[e.key]];r&&navigator.clipboard.writeText(r)}catch{console.error(`Invalid JSON in localStorage`)}}};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[]),null),So=[`Live`,`Email`,`igdm`,`Xdm`,`dmFb`,`Playstore`,`155`],V=({Segment:e,onChange:t})=>(0,L.jsx)(`select`,{className:`mr-30 border-2 border-black text-center border-select`,value:e,onChange:e=>t(e.target.value),children:So.map(n=>(0,L.jsx)(`option`,{onClick:()=>t(n),className:`px-1 py-1 border ${e===n?`text black`:``}`,children:n},n))});function Co(){let[e,t]=(0,l.useState)(`notepad`),[n,r]=(0,l.useState)(`Live`);return(0,L.jsxs)(`div`,{className:`flex flex-col `,children:[(0,L.jsx)(xo,{}),(0,L.jsxs)(`div`,{className:`flex gap-2 p-2 border-b`,children:[(0,L.jsx)(`button`,{className:`border px-4 ${e===`notepad`&&`bg-yellow-200 text-black`}`,onClick:()=>t(`notepad`),children:`Notepad`}),(0,L.jsx)(`button`,{className:`border px-4 ${e===`tiket`&&`bg-yellow-200 text-black`}`,onClick:()=>t(`tiket`),children:`Mandatory`}),(0,L.jsx)(`button`,{className:`border px-4 ${e===`Template`&&`bg-yellow-200 text-black`}`,onClick:()=>t(`Template`),children:`Template`}),(0,L.jsx)(`div`,{className:`ml-auto flex items-center gap-2`,children:(0,L.jsx)(V,{Segment:n,onChange:r})}),(0,L.jsxs)(`div`,{className:`absolute top-1 right-0 flex gap-1`,children:[(0,L.jsx)(yo,{}),(0,L.jsxs)(`h1`,{className:`text-3xl tracking-[.2em]`,children:[`di`,(0,L.jsx)(`span`,{className:`text-red-600`,children:`N`})]})]})]}),(0,L.jsxs)(`div`,{className:`flex `,children:[e===`notepad`&&(0,L.jsx)(bo,{}),e===`tiket`&&(0,L.jsx)(ro,{segment:n}),e===`Template`&&(0,L.jsx)(io,{})]})]})}var wo=`modulepreload`,To=function(e){return`/Smart-Attacker/`+e},Eo={};const Do=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=To(t,n),t in Eo)return;Eo[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:wo,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})};var Oo=`popstate`;function ko(e={}){function t(e,t){let{pathname:n=`/`,search:r=``,hash:i=``}=Po(e.location.hash.substring(1));return!n.startsWith(`/`)&&!n.startsWith(`.`)&&(n=`/`+n),Mo(``,{pathname:n,search:r,hash:i},t.state&&t.state.usr||null,t.state&&t.state.key||`default`)}function n(e,t){let n=e.document.querySelector(`base`),r=``;if(n&&n.getAttribute(`href`)){let t=e.location.href,n=t.indexOf(`#`);r=n===-1?t:t.slice(0,n)}return r+`#`+(typeof t==`string`?t:No(t))}function r(e,t){U(e.pathname.charAt(0)===`/`,`relative pathnames are not supported in hash history.push(${JSON.stringify(t)})`)}return Fo(t,n,r,e)}function H(e,t){if(e===!1||e==null)throw Error(t)}function U(e,t){if(!e){typeof console<`u`&&console.warn(t);try{throw Error(t)}catch{}}}function Ao(){return Math.random().toString(36).substring(2,10)}function jo(e,t){return{usr:e.state,key:e.key,idx:t}}function Mo(e,t,n=null,r){return{pathname:typeof e==`string`?e:e.pathname,search:``,hash:``,...typeof t==`string`?Po(t):t,state:n,key:t&&t.key||r||Ao()}}function No({pathname:e=`/`,search:t=``,hash:n=``}){return t&&t!==`?`&&(e+=t.charAt(0)===`?`?t:`?`+t),n&&n!==`#`&&(e+=n.charAt(0)===`#`?n:`#`+n),e}function Po(e){let t={};if(e){let n=e.indexOf(`#`);n>=0&&(t.hash=e.substring(n),e=e.substring(0,n));let r=e.indexOf(`?`);r>=0&&(t.search=e.substring(r),e=e.substring(0,r)),e&&(t.pathname=e)}return t}function Fo(e,t,n,r={}){let{window:i=document.defaultView,v5Compat:a=!1}=r,o=i.history,s=`POP`,c=null,l=u();l??(l=0,o.replaceState({...o.state,idx:l},``));function u(){return(o.state||{idx:null}).idx}function d(){s=`POP`;let e=u(),t=e==null?null:e-l;l=e,c&&c({action:s,location:h.location,delta:t})}function f(e,t){s=`PUSH`;let r=Mo(h.location,e,t);n&&n(r,e),l=u()+1;let d=jo(r,l),f=h.createHref(r);try{o.pushState(d,``,f)}catch(e){if(e instanceof DOMException&&e.name===`DataCloneError`)throw e;i.location.assign(f)}a&&c&&c({action:s,location:h.location,delta:1})}function p(e,t){s=`REPLACE`;let r=Mo(h.location,e,t);n&&n(r,e),l=u();let i=jo(r,l),d=h.createHref(r);o.replaceState(i,``,d),a&&c&&c({action:s,location:h.location,delta:0})}function m(e){return Io(e)}let h={get action(){return s},get location(){return e(i,o)},listen(e){if(c)throw Error(`A history only accepts one active listener`);return i.addEventListener(Oo,d),c=e,()=>{i.removeEventListener(Oo,d),c=null}},createHref(e){return t(i,e)},createURL:m,encodeLocation(e){let t=m(e);return{pathname:t.pathname,search:t.search,hash:t.hash}},push:f,replace:p,go(e){return o.go(e)}};return h}function Io(e,t=!1){let n=`http://localhost`;typeof window<`u`&&(n=window.location.origin===`null`?window.location.href:window.location.origin),H(n,`No window.location.(origin|href) available to create URL`);let r=typeof e==`string`?e:No(e);return r=r.replace(/ $/,`%20`),!t&&r.startsWith(`//`)&&(r=n+r),new URL(r,n)}function Lo(e,t,n=`/`){return Ro(e,t,n,!1)}function Ro(e,t,n,r){let i=ns((typeof t==`string`?Po(t):t).pathname||`/`,n);if(i==null)return null;let a=Bo(e);Ho(a);let o=null;for(let e=0;o==null&&e<a.length;++e){let t=ts(i);o=Qo(a[e],t,r)}return o}function zo(e,t){let{route:n,pathname:r,params:i}=e;return{id:n.id,pathname:r,params:i,data:t[n.id],loaderData:t[n.id],handle:n.handle}}function Bo(e,t=[],n=[],r=``,i=!1){let a=(e,a,o=i,s)=>{let c={relativePath:s===void 0?e.path||``:s,caseSensitive:e.caseSensitive===!0,childrenIndex:a,route:e};if(c.relativePath.startsWith(`/`)){if(!c.relativePath.startsWith(r)&&o)return;H(c.relativePath.startsWith(r),`Absolute route path "${c.relativePath}" nested under path "${r}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),c.relativePath=c.relativePath.slice(r.length)}let l=ds([r,c.relativePath]),u=n.concat(c);e.children&&e.children.length>0&&(H(e.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${l}".`),Bo(e.children,t,u,l,o)),!(e.path==null&&!e.index)&&t.push({path:l,score:Xo(l,e.index),routesMeta:u})};return e.forEach((e,t)=>{if(e.path===``||!e.path?.includes(`?`))a(e,t);else for(let n of Vo(e.path))a(e,t,!0,n)}),t}function Vo(e){let t=e.split(`/`);if(t.length===0)return[];let[n,...r]=t,i=n.endsWith(`?`),a=n.replace(/\?$/,``);if(r.length===0)return i?[a,``]:[a];let o=Vo(r.join(`/`)),s=[];return s.push(...o.map(e=>e===``?a:[a,e].join(`/`))),i&&s.push(...o),s.map(t=>e.startsWith(`/`)&&t===``?`/`:t)}function Ho(e){e.sort((e,t)=>e.score===t.score?Zo(e.routesMeta.map(e=>e.childrenIndex),t.routesMeta.map(e=>e.childrenIndex)):t.score-e.score)}var Uo=/^:[\w-]+$/,Wo=3,Go=2,Ko=1,qo=10,Jo=-2,Yo=e=>e===`*`;function Xo(e,t){let n=e.split(`/`),r=n.length;return n.some(Yo)&&(r+=Jo),t&&(r+=Go),n.filter(e=>!Yo(e)).reduce((e,t)=>e+(Uo.test(t)?Wo:t===``?Ko:qo),r)}function Zo(e,t){return e.length===t.length&&e.slice(0,-1).every((e,n)=>e===t[n])?e[e.length-1]-t[t.length-1]:0}function Qo(e,t,n=!1){let{routesMeta:r}=e,i={},a=`/`,o=[];for(let e=0;e<r.length;++e){let s=r[e],c=e===r.length-1,l=a===`/`?t:t.slice(a.length)||`/`,u=$o({path:s.relativePath,caseSensitive:s.caseSensitive,end:c},l),d=s.route;if(!u&&c&&n&&!r[r.length-1].route.index&&(u=$o({path:s.relativePath,caseSensitive:s.caseSensitive,end:!1},l)),!u)return null;Object.assign(i,u.params),o.push({params:i,pathname:ds([a,u.pathname]),pathnameBase:fs(ds([a,u.pathnameBase])),route:d}),u.pathnameBase!==`/`&&(a=ds([a,u.pathnameBase]))}return o}function $o(e,t){typeof e==`string`&&(e={path:e,caseSensitive:!1,end:!0});let[n,r]=es(e.path,e.caseSensitive,e.end),i=t.match(n);if(!i)return null;let a=i[0],o=a.replace(/(.)\/+$/,`$1`),s=i.slice(1);return{params:r.reduce((e,{paramName:t,isOptional:n},r)=>{if(t===`*`){let e=s[r]||``;o=a.slice(0,a.length-e.length).replace(/(.)\/+$/,`$1`)}let i=s[r];return n&&!i?e[t]=void 0:e[t]=(i||``).replace(/%2F/g,`/`),e},{}),pathname:a,pathnameBase:o,pattern:e}}function es(e,t=!1,n=!0){U(e===`*`||!e.endsWith(`*`)||e.endsWith(`/*`),`Route path "${e}" will be treated as if it were "${e.replace(/\*$/,`/*`)}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${e.replace(/\*$/,`/*`)}".`);let r=[],i=`^`+e.replace(/\/*\*?$/,``).replace(/^\/*/,`/`).replace(/[\\.*+^${}|()[\]]/g,`\\$&`).replace(/\/:([\w-]+)(\?)?/g,(e,t,n)=>(r.push({paramName:t,isOptional:n!=null}),n?`/?([^\\/]+)?`:`/([^\\/]+)`)).replace(/\/([\w-]+)\?(\/|$)/g,`(/$1)?$2`);return e.endsWith(`*`)?(r.push({paramName:`*`}),i+=e===`*`||e===`/*`?`(.*)$`:`(?:\\/(.+)|\\/*)$`):n?i+=`\\/*$`:e!==``&&e!==`/`&&(i+=`(?:(?=\\/|$))`),[new RegExp(i,t?void 0:`i`),r]}function ts(e){try{return e.split(`/`).map(e=>decodeURIComponent(e).replace(/\//g,`%2F`)).join(`/`)}catch(t){return U(!1,`The URL path "${e}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${t}).`),e}}function ns(e,t){if(t===`/`)return e;if(!e.toLowerCase().startsWith(t.toLowerCase()))return null;let n=t.endsWith(`/`)?t.length-1:t.length,r=e.charAt(n);return r&&r!==`/`?null:e.slice(n)||`/`}var rs=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,is=e=>rs.test(e);function as(e,t=`/`){let{pathname:n,search:r=``,hash:i=``}=typeof e==`string`?Po(e):e,a;if(n)if(is(n))a=n;else{if(n.includes(`//`)){let e=n;n=n.replace(/\/\/+/g,`/`),U(!1,`Pathnames cannot have embedded double slashes - normalizing ${e} -> ${n}`)}a=n.startsWith(`/`)?os(n.substring(1),`/`):os(n,t)}else a=t;return{pathname:a,search:ps(r),hash:ms(i)}}function os(e,t){let n=t.replace(/\/+$/,``).split(`/`);return e.split(`/`).forEach(e=>{e===`..`?n.length>1&&n.pop():e!==`.`&&n.push(e)}),n.length>1?n.join(`/`):`/`}function ss(e,t,n,r){return`Cannot include a '${e}' character in a manually specified \`to.${t}\` field [${JSON.stringify(r)}].  Please separate it out to the \`to.${n}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function cs(e){return e.filter((e,t)=>t===0||e.route.path&&e.route.path.length>0)}function ls(e){let t=cs(e);return t.map((e,n)=>n===t.length-1?e.pathname:e.pathnameBase)}function us(e,t,n,r=!1){let i;typeof e==`string`?i=Po(e):(i={...e},H(!i.pathname||!i.pathname.includes(`?`),ss(`?`,`pathname`,`search`,i)),H(!i.pathname||!i.pathname.includes(`#`),ss(`#`,`pathname`,`hash`,i)),H(!i.search||!i.search.includes(`#`),ss(`#`,`search`,`hash`,i)));let a=e===``||i.pathname===``,o=a?`/`:i.pathname,s;if(o==null)s=n;else{let e=t.length-1;if(!r&&o.startsWith(`..`)){let t=o.split(`/`);for(;t[0]===`..`;)t.shift(),--e;i.pathname=t.join(`/`)}s=e>=0?t[e]:`/`}let c=as(i,s),l=o&&o!==`/`&&o.endsWith(`/`),u=(a||o===`.`)&&n.endsWith(`/`);return!c.pathname.endsWith(`/`)&&(l||u)&&(c.pathname+=`/`),c}var ds=e=>e.join(`/`).replace(/\/\/+/g,`/`),fs=e=>e.replace(/\/+$/,``).replace(/^\/*/,`/`),ps=e=>!e||e===`?`?``:e.startsWith(`?`)?e:`?`+e,ms=e=>!e||e===`#`?``:e.startsWith(`#`)?e:`#`+e;function hs(e){return e!=null&&typeof e.status==`number`&&typeof e.statusText==`string`&&typeof e.internal==`boolean`&&`data`in e}function gs(e){return e.map(e=>e.route.path).filter(Boolean).join(`/`).replace(/\/\/*/g,`/`)||`/`}Object.getOwnPropertyNames(Object.prototype).sort().join(`\0`);var _s=l.createContext(null);_s.displayName=`DataRouter`;var vs=l.createContext(null);vs.displayName=`DataRouterState`,l.createContext(!1);var ys=l.createContext({isTransitioning:!1});ys.displayName=`ViewTransition`;var bs=l.createContext(new Map);bs.displayName=`Fetchers`;var xs=l.createContext(null);xs.displayName=`Await`;var Ss=l.createContext(null);Ss.displayName=`Navigation`;var Cs=l.createContext(null);Cs.displayName=`Location`;var ws=l.createContext({outlet:null,matches:[],isDataRoute:!1});ws.displayName=`Route`;var Ts=l.createContext(null);Ts.displayName=`RouteError`;function Es(e,{relative:t}={}){H(Ds(),`useHref() may be used only in the context of a <Router> component.`);let{basename:n,navigator:r}=l.useContext(Ss),{hash:i,pathname:a,search:o}=Ns(e,{relative:t}),s=a;return n!==`/`&&(s=a===`/`?n:ds([n,a])),r.createHref({pathname:s,search:o,hash:i})}function Ds(){return l.useContext(Cs)!=null}function Os(){return H(Ds(),`useLocation() may be used only in the context of a <Router> component.`),l.useContext(Cs).location}var ks=`You should call navigate() in a React.useEffect(), not when your component is first rendered.`;function As(e){l.useContext(Ss).static||l.useLayoutEffect(e)}function js(){let{isDataRoute:e}=l.useContext(ws);return e?Ys():Ms()}function Ms(){H(Ds(),`useNavigate() may be used only in the context of a <Router> component.`);let e=l.useContext(_s),{basename:t,navigator:n}=l.useContext(Ss),{matches:r}=l.useContext(ws),{pathname:i}=Os(),a=JSON.stringify(ls(r)),o=l.useRef(!1);return As(()=>{o.current=!0}),l.useCallback((r,s={})=>{if(U(o.current,ks),!o.current)return;if(typeof r==`number`){n.go(r);return}let c=us(r,JSON.parse(a),i,s.relative===`path`);e==null&&t!==`/`&&(c.pathname=c.pathname===`/`?t:ds([t,c.pathname])),(s.replace?n.replace:n.push)(c,s.state,s)},[t,n,a,i,e])}l.createContext(null);function Ns(e,{relative:t}={}){let{matches:n}=l.useContext(ws),{pathname:r}=Os(),i=JSON.stringify(ls(n));return l.useMemo(()=>us(e,JSON.parse(i),r,t===`path`),[e,i,r,t])}function Ps(e,t,n,r,i){H(Ds(),`useRoutes() may be used only in the context of a <Router> component.`);let{navigator:a}=l.useContext(Ss),{matches:o}=l.useContext(ws),s=o[o.length-1],c=s?s.params:{},u=s?s.pathname:`/`,d=s?s.pathnameBase:`/`,f=s&&s.route;{let e=f&&f.path||``;Zs(u,!f||e.endsWith(`*`)||e.endsWith(`*?`),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${u}" (under <Route path="${e}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${e}"> to <Route path="${e===`/`?`*`:`${e}/*`}">.`)}let p=Os(),m;if(t){let e=typeof t==`string`?Po(t):t;H(d===`/`||e.pathname?.startsWith(d),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${d}" but pathname "${e.pathname}" was given in the \`location\` prop.`),m=e}else m=p;let h=m.pathname||`/`,g=h;if(d!==`/`){let e=d.replace(/^\//,``).split(`/`);g=`/`+h.replace(/^\//,``).split(`/`).slice(e.length).join(`/`)}let _=Lo(e,{pathname:g});U(f||_!=null,`No routes matched location "${m.pathname}${m.search}${m.hash}" `),U(_==null||_[_.length-1].route.element!==void 0||_[_.length-1].route.Component!==void 0||_[_.length-1].route.lazy!==void 0,`Matched leaf route at location "${m.pathname}${m.search}${m.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let v=zs(_&&_.map(e=>Object.assign({},e,{params:Object.assign({},c,e.params),pathname:ds([d,a.encodeLocation?a.encodeLocation(e.pathname.replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathname]),pathnameBase:e.pathnameBase===`/`?d:ds([d,a.encodeLocation?a.encodeLocation(e.pathnameBase.replace(/\?/g,`%3F`).replace(/#/g,`%23`)).pathname:e.pathnameBase])})),o,n,r,i);return t&&v?l.createElement(Cs.Provider,{value:{location:{pathname:`/`,search:``,hash:``,state:null,key:`default`,...m},navigationType:`POP`}},v):v}function Fs(){let e=Js(),t=hs(e)?`${e.status} ${e.statusText}`:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,r=`rgba(200,200,200, 0.5)`,i={padding:`0.5rem`,backgroundColor:r},a={padding:`2px 4px`,backgroundColor:r},o=null;return console.error(`Error handled by React Router default ErrorBoundary:`,e),o=l.createElement(l.Fragment,null,l.createElement(`p`,null,`💿 Hey developer 👋`),l.createElement(`p`,null,`You can provide a way better UX than this when your app throws errors by providing your own `,l.createElement(`code`,{style:a},`ErrorBoundary`),` or`,` `,l.createElement(`code`,{style:a},`errorElement`),` prop on your route.`)),l.createElement(l.Fragment,null,l.createElement(`h2`,null,`Unexpected Application Error!`),l.createElement(`h3`,{style:{fontStyle:`italic`}},t),n?l.createElement(`pre`,{style:i},n):null,o)}var Is=l.createElement(Fs,null),Ls=class extends l.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,t){return t.location!==e.location||t.revalidation!==`idle`&&e.revalidation===`idle`?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error===void 0?t.error:e.error,location:t.location,revalidation:e.revalidation||t.revalidation}}componentDidCatch(e,t){this.props.onError?this.props.onError(e,t):console.error(`React Router caught the following error during render`,e)}render(){return this.state.error===void 0?this.props.children:l.createElement(ws.Provider,{value:this.props.routeContext},l.createElement(Ts.Provider,{value:this.state.error,children:this.props.component}))}};function Rs({routeContext:e,match:t,children:n}){let r=l.useContext(_s);return r&&r.static&&r.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=t.route.id),l.createElement(ws.Provider,{value:e},n)}function zs(e,t=[],n=null,r=null,i=null){if(e==null){if(!n)return null;if(n.errors)e=n.matches;else if(t.length===0&&!n.initialized&&n.matches.length>0)e=n.matches;else return null}let a=e,o=n?.errors;if(o!=null){let e=a.findIndex(e=>e.route.id&&o?.[e.route.id]!==void 0);H(e>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(o).join(`,`)}`),a=a.slice(0,Math.min(a.length,e+1))}let s=!1,c=-1;if(n)for(let e=0;e<a.length;e++){let t=a[e];if((t.route.HydrateFallback||t.route.hydrateFallbackElement)&&(c=e),t.route.id){let{loaderData:e,errors:r}=n,i=t.route.loader&&!e.hasOwnProperty(t.route.id)&&(!r||r[t.route.id]===void 0);if(t.route.lazy||i){s=!0,a=c>=0?a.slice(0,c+1):[a[0]];break}}}let u=n&&r?(e,t)=>{r(e,{location:n.location,params:n.matches?.[0]?.params??{},unstable_pattern:gs(n.matches),errorInfo:t})}:void 0;return a.reduceRight((e,r,i)=>{let d,f=!1,p=null,m=null;n&&(d=o&&r.route.id?o[r.route.id]:void 0,p=r.route.errorElement||Is,s&&(c<0&&i===0?(Zs(`route-fallback`,!1,"No `HydrateFallback` element provided to render during initial hydration"),f=!0,m=null):c===i&&(f=!0,m=r.route.hydrateFallbackElement||null)));let h=t.concat(a.slice(0,i+1)),g=()=>{let t;return t=d?p:f?m:r.route.Component?l.createElement(r.route.Component,null):r.route.element?r.route.element:e,l.createElement(Rs,{match:r,routeContext:{outlet:e,matches:h,isDataRoute:n!=null},children:t})};return n&&(r.route.ErrorBoundary||r.route.errorElement||i===0)?l.createElement(Ls,{location:n.location,revalidation:n.revalidation,component:p,error:d,children:g(),routeContext:{outlet:null,matches:h,isDataRoute:!0},onError:u}):g()},null)}function Bs(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Vs(e){let t=l.useContext(_s);return H(t,Bs(e)),t}function Hs(e){let t=l.useContext(vs);return H(t,Bs(e)),t}function Us(e){let t=l.useContext(ws);return H(t,Bs(e)),t}function Ws(e){let t=Us(e),n=t.matches[t.matches.length-1];return H(n.route.id,`${e} can only be used on routes that contain a unique "id"`),n.route.id}function Gs(){return Ws(`useRouteId`)}function Ks(){return Hs(`useNavigation`).navigation}function qs(){let{matches:e,loaderData:t}=Hs(`useMatches`);return l.useMemo(()=>e.map(e=>zo(e,t)),[e,t])}function Js(){let e=l.useContext(Ts),t=Hs(`useRouteError`),n=Ws(`useRouteError`);return e===void 0?t.errors?.[n]:e}function Ys(){let{router:e}=Vs(`useNavigate`),t=Ws(`useNavigate`),n=l.useRef(!1);return As(()=>{n.current=!0}),l.useCallback(async(r,i={})=>{U(n.current,ks),n.current&&(typeof r==`number`?await e.navigate(r):await e.navigate(r,{fromRouteId:t,...i}))},[e,t])}var Xs={};function Zs(e,t,n){!t&&!Xs[e]&&(Xs[e]=!0,U(!1,n))}l.useOptimistic,l.memo(Qs);function Qs({routes:e,future:t,state:n,unstable_onError:r}){return Ps(e,void 0,n,r,t)}function $s({basename:e=`/`,children:t=null,location:n,navigationType:r=`POP`,navigator:i,static:a=!1,unstable_useTransitions:o}){H(!Ds(),`You cannot render a <Router> inside another <Router>. You should never have more than one in your app.`);let s=e.replace(/^\/*/,`/`),c=l.useMemo(()=>({basename:s,navigator:i,static:a,unstable_useTransitions:o,future:{}}),[s,i,a,o]);typeof n==`string`&&(n=Po(n));let{pathname:u=`/`,search:d=``,hash:f=``,state:p=null,key:m=`default`}=n,h=l.useMemo(()=>{let e=ns(u,s);return e==null?null:{location:{pathname:e,search:d,hash:f,state:p,key:m},navigationType:r}},[s,u,d,f,p,m,r]);return U(h!=null,`<Router basename="${s}"> is not able to match the URL "${u}${d}${f}" because it does not start with the basename, so the <Router> won't render anything.`),h==null?null:l.createElement(Ss.Provider,{value:c},l.createElement(Cs.Provider,{children:t,value:h}))}var ec=`get`,tc=`application/x-www-form-urlencoded`;function nc(e){return typeof HTMLElement<`u`&&e instanceof HTMLElement}function rc(e){return nc(e)&&e.tagName.toLowerCase()===`button`}function ic(e){return nc(e)&&e.tagName.toLowerCase()===`form`}function ac(e){return nc(e)&&e.tagName.toLowerCase()===`input`}function oc(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function sc(e,t){return e.button===0&&(!t||t===`_self`)&&!oc(e)}var cc=null;function lc(){if(cc===null)try{new FormData(document.createElement(`form`),0),cc=!1}catch{cc=!0}return cc}var uc=new Set([`application/x-www-form-urlencoded`,`multipart/form-data`,`text/plain`]);function dc(e){return e!=null&&!uc.has(e)?(U(!1,`"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${tc}"`),null):e}function fc(e,t){let n,r,i,a,o;if(ic(e)){let o=e.getAttribute(`action`);r=o?ns(o,t):null,n=e.getAttribute(`method`)||ec,i=dc(e.getAttribute(`enctype`))||tc,a=new FormData(e)}else if(rc(e)||ac(e)&&(e.type===`submit`||e.type===`image`)){let o=e.form;if(o==null)throw Error(`Cannot submit a <button> or <input type="submit"> without a <form>`);let s=e.getAttribute(`formaction`)||o.getAttribute(`action`);if(r=s?ns(s,t):null,n=e.getAttribute(`formmethod`)||o.getAttribute(`method`)||ec,i=dc(e.getAttribute(`formenctype`))||dc(o.getAttribute(`enctype`))||tc,a=new FormData(o,e),!lc()){let{name:t,type:n,value:r}=e;if(n===`image`){let e=t?`${t}.`:``;a.append(`${e}x`,`0`),a.append(`${e}y`,`0`)}else t&&a.append(t,r)}}else if(nc(e))throw Error(`Cannot submit element that is not <form>, <button>, or <input type="submit|image">`);else n=ec,r=null,i=tc,o=e;return a&&i===`text/plain`&&(o=a,a=void 0),{action:r,method:n.toLowerCase(),encType:i,formData:a,body:o}}Object.getOwnPropertyNames(Object.prototype).sort().join(`\0`);function pc(e,t){if(e===!1||e==null)throw Error(t)}function mc(e,t,n){let r=typeof e==`string`?new URL(e,typeof window>`u`?`server://singlefetch/`:window.location.origin):e;return r.pathname===`/`?r.pathname=`_root.${n}`:t&&ns(r.pathname,t)===`/`?r.pathname=`${t.replace(/\/$/,``)}/_root.${n}`:r.pathname=`${r.pathname.replace(/\/$/,``)}.${n}`,r}async function hc(e,t){if(e.id in t)return t[e.id];try{let n=await Do(()=>import(e.module),[]);return t[e.id]=n,n}catch(t){return console.error(`Error loading route module \`${e.module}\`, reloading page...`),console.error(t),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function gc(e){return e!=null&&typeof e.page==`string`}function _c(e){return e==null?!1:e.href==null?e.rel===`preload`&&typeof e.imageSrcSet==`string`&&typeof e.imageSizes==`string`:typeof e.rel==`string`&&typeof e.href==`string`}async function vc(e,t,n){return Cc((await Promise.all(e.map(async e=>{let r=t.routes[e.route.id];if(r){let e=await hc(r,n);return e.links?e.links():[]}return[]}))).flat(1).filter(_c).filter(e=>e.rel===`stylesheet`||e.rel===`preload`).map(e=>e.rel===`stylesheet`?{...e,rel:`prefetch`,as:`style`}:{...e,rel:`prefetch`}))}function yc(e,t,n,r,i,a){let o=(e,t)=>n[t]?e.route.id!==n[t].route.id:!0,s=(e,t)=>n[t].pathname!==e.pathname||n[t].route.path?.endsWith(`*`)&&n[t].params[`*`]!==e.params[`*`];return a===`assets`?t.filter((e,t)=>o(e,t)||s(e,t)):a===`data`?t.filter((t,a)=>{let c=r.routes[t.route.id];if(!c||!c.hasLoader)return!1;if(o(t,a)||s(t,a))return!0;if(t.route.shouldRevalidate){let r=t.route.shouldRevalidate({currentUrl:new URL(i.pathname+i.search+i.hash,window.origin),currentParams:n[0]?.params||{},nextUrl:new URL(e,window.origin),nextParams:t.params,defaultShouldRevalidate:!0});if(typeof r==`boolean`)return r}return!0}):[]}function bc(e,t,{includeHydrateFallback:n}={}){return xc(e.map(e=>{let r=t.routes[e.route.id];if(!r)return[];let i=[r.module];return r.clientActionModule&&(i=i.concat(r.clientActionModule)),r.clientLoaderModule&&(i=i.concat(r.clientLoaderModule)),n&&r.hydrateFallbackModule&&(i=i.concat(r.hydrateFallbackModule)),r.imports&&(i=i.concat(r.imports)),i}).flat(1))}function xc(e){return[...new Set(e)]}function Sc(e){let t={},n=Object.keys(e).sort();for(let r of n)t[r]=e[r];return t}function Cc(e,t){let n=new Set,r=new Set(t);return e.reduce((e,i)=>{if(t&&!gc(i)&&i.as===`script`&&i.href&&r.has(i.href))return e;let a=JSON.stringify(Sc(i));return n.has(a)||(n.add(a),e.push({key:a,link:i})),e},[])}function wc(){let e=l.useContext(_s);return pc(e,`You must render this element inside a <DataRouterContext.Provider> element`),e}function Tc(){let e=l.useContext(vs);return pc(e,`You must render this element inside a <DataRouterStateContext.Provider> element`),e}var Ec=l.createContext(void 0);Ec.displayName=`FrameworkContext`;function Dc(){let e=l.useContext(Ec);return pc(e,`You must render this element inside a <HydratedRouter> element`),e}function Oc(e,t){let n=l.useContext(Ec),[r,i]=l.useState(!1),[a,o]=l.useState(!1),{onFocus:s,onBlur:c,onMouseEnter:u,onMouseLeave:d,onTouchStart:f}=t,p=l.useRef(null);l.useEffect(()=>{if(e===`render`&&o(!0),e===`viewport`){let e=new IntersectionObserver(e=>{e.forEach(e=>{o(e.isIntersecting)})},{threshold:.5});return p.current&&e.observe(p.current),()=>{e.disconnect()}}},[e]),l.useEffect(()=>{if(r){let e=setTimeout(()=>{o(!0)},100);return()=>{clearTimeout(e)}}},[r]);let m=()=>{i(!0)},h=()=>{i(!1),o(!1)};return n?e===`intent`?[a,p,{onFocus:kc(s,m),onBlur:kc(c,h),onMouseEnter:kc(u,m),onMouseLeave:kc(d,h),onTouchStart:kc(f,m)}]:[a,p,{}]:[!1,p,{}]}function kc(e,t){return n=>{e&&e(n),n.defaultPrevented||t(n)}}function Ac({page:e,...t}){let{router:n}=wc(),r=l.useMemo(()=>Lo(n.routes,e,n.basename),[n.routes,e,n.basename]);return r?l.createElement(Mc,{page:e,matches:r,...t}):null}function jc(e){let{manifest:t,routeModules:n}=Dc(),[r,i]=l.useState([]);return l.useEffect(()=>{let r=!1;return vc(e,t,n).then(e=>{r||i(e)}),()=>{r=!0}},[e,t,n]),r}function Mc({page:e,matches:t,...n}){let r=Os(),{manifest:i,routeModules:a}=Dc(),{basename:o}=wc(),{loaderData:s,matches:c}=Tc(),u=l.useMemo(()=>yc(e,t,c,i,r,`data`),[e,t,c,i,r]),d=l.useMemo(()=>yc(e,t,c,i,r,`assets`),[e,t,c,i,r]),f=l.useMemo(()=>{if(e===r.pathname+r.search+r.hash)return[];let n=new Set,c=!1;if(t.forEach(e=>{let t=i.routes[e.route.id];!t||!t.hasLoader||(!u.some(t=>t.route.id===e.route.id)&&e.route.id in s&&a[e.route.id]?.shouldRevalidate||t.hasClientLoader?c=!0:n.add(e.route.id))}),n.size===0)return[];let l=mc(e,o,`data`);return c&&n.size>0&&l.searchParams.set(`_routes`,t.filter(e=>n.has(e.route.id)).map(e=>e.route.id).join(`,`)),[l.pathname+l.search]},[o,s,r,i,u,t,e,a]),p=l.useMemo(()=>bc(d,i),[d,i]),m=jc(d);return l.createElement(l.Fragment,null,f.map(e=>l.createElement(`link`,{key:e,rel:`prefetch`,as:`fetch`,href:e,...n})),p.map(e=>l.createElement(`link`,{key:e,rel:`modulepreload`,href:e,...n})),m.map(({key:e,link:t})=>l.createElement(`link`,{key:e,nonce:n.nonce,...t})))}function Nc(...e){return t=>{e.forEach(e=>{typeof e==`function`?e(t):e!=null&&(e.current=t)})}}var Pc=typeof window<`u`&&window.document!==void 0&&window.document.createElement!==void 0;try{Pc&&(window.__reactRouterVersion=`7.10.0`)}catch{}function Fc({basename:e,children:t,unstable_useTransitions:n,window:r}){let i=l.useRef();i.current??=ko({window:r,v5Compat:!0});let a=i.current,[o,s]=l.useState({action:a.action,location:a.location}),c=l.useCallback(e=>{n===!1?s(e):l.startTransition(()=>s(e))},[n]);return l.useLayoutEffect(()=>a.listen(c),[a,c]),l.createElement($s,{basename:e,children:t,location:o.location,navigationType:o.action,navigator:a,unstable_useTransitions:n===!0})}function Ic({basename:e,children:t,history:n,unstable_useTransitions:r}){let[i,a]=l.useState({action:n.action,location:n.location}),o=l.useCallback(e=>{r===!1?a(e):l.startTransition(()=>a(e))},[r]);return l.useLayoutEffect(()=>n.listen(o),[n,o]),l.createElement($s,{basename:e,children:t,location:i.location,navigationType:i.action,navigator:n,unstable_useTransitions:r===!0})}Ic.displayName=`unstable_HistoryRouter`;var Lc=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,W=l.forwardRef(function({onClick:e,discover:t=`render`,prefetch:n=`none`,relative:r,reloadDocument:i,replace:a,state:o,target:s,to:c,preventScrollReset:u,viewTransition:d,...f},p){let{basename:m,unstable_useTransitions:h}=l.useContext(Ss),g=typeof c==`string`&&Lc.test(c),_,v=!1;if(typeof c==`string`&&g&&(_=c,Pc))try{let e=new URL(window.location.href),t=c.startsWith(`//`)?new URL(e.protocol+c):new URL(c),n=ns(t.pathname,m);t.origin===e.origin&&n!=null?c=n+t.search+t.hash:v=!0}catch{U(!1,`<Link to="${c}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let y=Es(c,{relative:r}),[b,x,S]=Oc(n,f),C=Wc(c,{replace:a,state:o,target:s,preventScrollReset:u,relative:r,viewTransition:d,unstable_useTransitions:h});function w(t){e&&e(t),t.defaultPrevented||C(t)}let T=l.createElement(`a`,{...f,...S,href:_||y,onClick:v||i?e:w,ref:Nc(p,x),target:s,"data-discover":!g&&t===`render`?`true`:void 0});return b&&!g?l.createElement(l.Fragment,null,T,l.createElement(Ac,{page:y})):T});W.displayName=`Link`;var Rc=l.forwardRef(function({"aria-current":e=`page`,caseSensitive:t=!1,className:n=``,end:r=!1,style:i,to:a,viewTransition:o,children:s,...c},u){let d=Ns(a,{relative:c.relative}),f=Os(),p=l.useContext(vs),{navigator:m,basename:h}=l.useContext(Ss),g=p!=null&&el(d)&&o===!0,_=m.encodeLocation?m.encodeLocation(d).pathname:d.pathname,v=f.pathname,y=p&&p.navigation&&p.navigation.location?p.navigation.location.pathname:null;t||(v=v.toLowerCase(),y=y?y.toLowerCase():null,_=_.toLowerCase()),y&&h&&(y=ns(y,h)||y);let b=_!==`/`&&_.endsWith(`/`)?_.length-1:_.length,x=v===_||!r&&v.startsWith(_)&&v.charAt(b)===`/`,S=y!=null&&(y===_||!r&&y.startsWith(_)&&y.charAt(_.length)===`/`),C={isActive:x,isPending:S,isTransitioning:g},w=x?e:void 0,T;T=typeof n==`function`?n(C):[n,x?`active`:null,S?`pending`:null,g?`transitioning`:null].filter(Boolean).join(` `);let E=typeof i==`function`?i(C):i;return l.createElement(W,{...c,"aria-current":w,className:T,ref:u,style:E,to:a,viewTransition:o},typeof s==`function`?s(C):s)});Rc.displayName=`NavLink`;var zc=l.forwardRef(({discover:e=`render`,fetcherKey:t,navigate:n,reloadDocument:r,replace:i,state:a,method:o=ec,action:s,onSubmit:c,relative:u,preventScrollReset:d,viewTransition:f,...p},m)=>{let{unstable_useTransitions:h}=l.useContext(Ss),g=qc(),_=Jc(s,{relative:u}),v=o.toLowerCase()===`get`?`get`:`post`,y=typeof s==`string`&&Lc.test(s);return l.createElement(`form`,{ref:m,method:v,action:_,onSubmit:r?c:e=>{if(c&&c(e),e.defaultPrevented)return;e.preventDefault();let r=e.nativeEvent.submitter,s=r?.getAttribute(`formmethod`)||o,p=()=>g(r||e.currentTarget,{fetcherKey:t,method:s,navigate:n,replace:i,state:a,relative:u,preventScrollReset:d,viewTransition:f});h&&n!==!1?l.startTransition(()=>p()):p()},...p,"data-discover":!y&&e===`render`?`true`:void 0})});zc.displayName=`Form`;function Bc({getKey:e,storageKey:t,...n}){let r=l.useContext(Ec),{basename:i}=l.useContext(Ss),a=Os(),o=qs();Qc({getKey:e,storageKey:t});let s=l.useMemo(()=>{if(!r||!e)return null;let t=Zc(a,o,i,e);return t===a.key?null:t},[]);if(!r||r.isSpaMode)return null;let c=((e,t)=>{if(!window.history.state||!window.history.state.key){let e=Math.random().toString(32).slice(2);window.history.replaceState({key:e},``)}try{let n=JSON.parse(sessionStorage.getItem(e)||`{}`)[t||window.history.state.key];typeof n==`number`&&window.scrollTo(0,n)}catch(t){console.error(t),sessionStorage.removeItem(e)}}).toString();return l.createElement(`script`,{...n,suppressHydrationWarning:!0,dangerouslySetInnerHTML:{__html:`(${c})(${JSON.stringify(t||Yc)}, ${JSON.stringify(s)})`}})}Bc.displayName=`ScrollRestoration`;function Vc(e){return`${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Hc(e){let t=l.useContext(_s);return H(t,Vc(e)),t}function Uc(e){let t=l.useContext(vs);return H(t,Vc(e)),t}function Wc(e,{target:t,replace:n,state:r,preventScrollReset:i,relative:a,viewTransition:o,unstable_useTransitions:s}={}){let c=js(),u=Os(),d=Ns(e,{relative:a});return l.useCallback(f=>{if(sc(f,t)){f.preventDefault();let t=n===void 0?No(u)===No(d):n,p=()=>c(e,{replace:t,state:r,preventScrollReset:i,relative:a,viewTransition:o});s?l.startTransition(()=>p()):p()}},[u,c,d,n,r,t,e,i,a,o,s])}var Gc=0,Kc=()=>`__${String(++Gc)}__`;function qc(){let{router:e}=Hc(`useSubmit`),{basename:t}=l.useContext(Ss),n=Gs(),r=e.fetch,i=e.navigate;return l.useCallback(async(e,a={})=>{let{action:o,method:s,encType:c,formData:l,body:u}=fc(e,t);a.navigate===!1?await r(a.fetcherKey||Kc(),n,a.action||o,{preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,flushSync:a.flushSync}):await i(a.action||o,{preventScrollReset:a.preventScrollReset,formData:l,body:u,formMethod:a.method||s,formEncType:a.encType||c,replace:a.replace,state:a.state,fromRouteId:n,flushSync:a.flushSync,viewTransition:a.viewTransition})},[r,i,t,n])}function Jc(e,{relative:t}={}){let{basename:n}=l.useContext(Ss),r=l.useContext(ws);H(r,`useFormAction must be used inside a RouteContext`);let[i]=r.matches.slice(-1),a={...Ns(e||`.`,{relative:t})},o=Os();if(e==null){a.search=o.search;let e=new URLSearchParams(a.search),t=e.getAll(`index`);if(t.some(e=>e===``)){e.delete(`index`),t.filter(e=>e).forEach(t=>e.append(`index`,t));let n=e.toString();a.search=n?`?${n}`:``}}return(!e||e===`.`)&&i.route.index&&(a.search=a.search?a.search.replace(/^\?/,`?index&`):`?index`),n!==`/`&&(a.pathname=a.pathname===`/`?n:ds([n,a.pathname])),No(a)}var Yc=`react-router-scroll-positions`,Xc={};function Zc(e,t,n,r){let i=null;return r&&(i=r(n===`/`?e:{...e,pathname:ns(e.pathname,n)||e.pathname},t)),i??=e.key,i}function Qc({getKey:e,storageKey:t}={}){let{router:n}=Hc(`useScrollRestoration`),{restoreScrollPosition:r,preventScrollReset:i}=Uc(`useScrollRestoration`),{basename:a}=l.useContext(Ss),o=Os(),s=qs(),c=Ks();l.useEffect(()=>(window.history.scrollRestoration=`manual`,()=>{window.history.scrollRestoration=`auto`}),[]),$c(l.useCallback(()=>{if(c.state===`idle`){let t=Zc(o,s,a,e);Xc[t]=window.scrollY}try{sessionStorage.setItem(t||Yc,JSON.stringify(Xc))}catch(e){U(!1,`Failed to save scroll positions in sessionStorage, <ScrollRestoration /> will not work properly (${e}).`)}window.history.scrollRestoration=`auto`},[c.state,e,a,o,s,t])),typeof document<`u`&&(l.useLayoutEffect(()=>{try{let e=sessionStorage.getItem(t||Yc);e&&(Xc=JSON.parse(e))}catch{}},[t]),l.useLayoutEffect(()=>{let t=n?.enableScrollRestoration(Xc,()=>window.scrollY,e?(t,n)=>Zc(t,n,a,e):void 0);return()=>t&&t()},[n,a,e]),l.useLayoutEffect(()=>{if(r!==!1){if(typeof r==`number`){window.scrollTo(0,r);return}try{if(o.hash){let e=document.getElementById(decodeURIComponent(o.hash.slice(1)));if(e){e.scrollIntoView();return}}}catch{U(!1,`"${o.hash.slice(1)}" is not a decodable element ID. The view will not scroll to it.`)}i!==!0&&window.scrollTo(0,0)}},[o,r,i]))}function $c(e,t){let{capture:n}=t||{};l.useEffect(()=>{let t=n==null?void 0:{capture:n};return window.addEventListener(`pagehide`,e,t),()=>{window.removeEventListener(`pagehide`,e,t)}},[e,n])}function el(e,{relative:t}={}){let n=l.useContext(ys);H(n!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:r}=Hc(`useViewTransitionState`),i=Ns(e,{relative:t});if(!n.isTransitioning)return!1;let a=ns(n.currentLocation.pathname,r)||n.currentLocation.pathname,o=ns(n.nextLocation.pathname,r)||n.nextLocation.pathname;return $o(i.pathname,o)!=null||$o(i.pathname,a)!=null}(0,c.createRoot)(document.getElementById(`root`)).render((0,L.jsx)(l.StrictMode,{children:(0,L.jsx)(Fc,{children:(0,L.jsx)(Co,{})})}));